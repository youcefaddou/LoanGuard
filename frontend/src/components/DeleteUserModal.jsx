        ...
        <div className="text-left">
          ...
          <div className="mb-6 space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-900">{user?.role === 'RES' ? 'Responsable' : 'Chargé de risques'}</span>
            </div>
          </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  Cette action est irréversible et supprimera définitivement l'utilisateur et ses données.
                </p>
              </div>
            </div>
          </div>
