...
export default function HeroAnimated() {
  const [refText, animText] = useSlideInOnView({
    direction: "right",
    delay: 0,
  });
  const [refGraph, animGraph] = useSlideInOnView({
    direction: "up",
    delay: 200,
  });
  return (
    <section className="bg-gray-50 pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div ref={refText} className={`space-y-8 ${animText}`}>
          ...
          <div className="flex justify-center lg:justify-end">
            <div ref={refGraph} className={`w-full max-w-md ${animGraph}`}>
              {/* Graphique simple */}
